    ...
    return (
        <main className="min-h-screen bg-gray-50 dark:bg-slate-900 font-[family-name:var(--font-metro)] text-gray-900 dark:text-white selection:bg-orange-100 dark:selection:bg-orange-900">
            ...
            <article className="max-w-4xl mx-auto px-6 py-12 lg:py-20">
                ...
                {/* Content */}
                <div className="prose prose-lg prose-orange max-w-none prose-headings:font-display prose-headings:font-bold prose-headings:text-gray-900 dark:prose-headings:text-white prose-h2:text-orange-500 dark:prose-h2:text-orange-400 prose-h2:font-black prose-h2:text-3xl prose-h3:text-orange-500 dark:prose-h3:text-orange-400 prose-h3:font-bold prose-h3:text-2xl prose-p:text-gray-600 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-li:text-gray-600 dark:prose-li:text-gray-300 prose-table:border prose-table:border-gray-200 dark:prose-table:border-slate-700 prose-text-gray-600 dark:prose-text-gray-300 dark:text-white prose-th:bg-gray-50 dark:prose-th:bg-slate-800 prose-th:text-gray-900 dark:prose-th:text-white prose-th:p-4 prose-td:p-4 prose-td:text-gray-600 dark:prose-td:text-gray-300 prose-tr:border-b prose-tr:border-gray-100 dark:prose-tr:border-slate-800">
