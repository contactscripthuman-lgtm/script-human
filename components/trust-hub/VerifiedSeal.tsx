                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6 animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="bg-gray-900 rounded-xl p-4 mb-4 relative group">
                            <code className="text-emerald-400 text-xs font-mono break-all block">
                                {`<iframe src="${typeof window !== 'undefined' ? window.location.origin : 'https://scripthuman.com'}/verify/${certificateId}/seal" width="280" height="100" frameborder="0" scrolling="no" style="border:none; overflow:hidden;"></iframe>`}
                            </code>
                            <button
                                onClick={() => {
                                    navigator.clipboard.writeText(`<iframe src="${window.location.origin}/verify/${certificateId}/seal" width="280" height="100" frameborder="0" scrolling="no" style="border:none; overflow:hidden;"></iframe>`);
